package com.eomcs.basic.ex04;
  ...
  public class Exam61 {
    ...
    public static void main(String[] args) {
        ...
        int[] score = new int[5];
      //  int score2[] = new int[5]; // c언어 style
      ...
      // 배열의 값을 저장하는 방법
         ...
         // score[-1] = 100; //runtime error! (실행오류)
         // score[5] = 100; //runtime error!

          // 배열 레퍼런스와 인스턴스를 따로 선언

         // int[] arr1 = null; //주소가 0 -> 메모리를 가리키지 않는다는뜻
